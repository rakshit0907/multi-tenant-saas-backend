...
var UsersService = /** @class */ (function () {
    function UsersService(userRepository, cls) {
    ...
    UsersService.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userRepository.findOne({ where: { email: email }, relations: ['tenant'] })];
            });
        });
    };
    UsersService.prototype.findAll = function () {
        var tenantId = this.cls.get('tenantId');
