...
export class TasksController {
      ...
      new ParseFilePipe({
        validators: [
          ...
          new FileTypeValidator({
            fileType: /(jpg|jpeg|png|webp|pdf|doc|docx|xls|xlsx|csv|txt|zip)$/,
          }),
        ],
      }),
    )
  ...
  async downloadAttachment(
    ...
    const attachment = await this.taskAttachmentsService.getAttachment(
      attachmentId,
      req.user.tenantId,
      req.user.userId,
    );
  ...
  getStats(@Param('projectId') projectId: string, @Req() req: any) {
  ...
  getLabels(@Param('projectId') projectId: string, @Req() req: any) {
